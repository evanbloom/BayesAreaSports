...
parser.add_argument("-min", "--min_year", type=int, default= 1960, choices=range(1960,2017),
                    help="first year to init")
parser.add_argument("-max", "--max_year", type=int, default= 2016, choices=range(1960,2017),
